    ...
    if (isOpen) {
      ...
      if (item) {
        ...
        setFormData({
          ...
          valorUnitario:
            item.supply?.valorUnitario || item.tool?.valorUnitario || 0,
        });
      }
    }
          ...
          <div className={styles.formGroup}>
            ...
            <div className={styles.quantityControl}>
              <input
                ...
                onChange={(e) =>
                  handleNumberChange("cantidadActual", e.target.value)
                }
                min="0"
                step={
                  isInsumo && formData.unidadMedida === "Unidad" ? "1" : "0.01"
                }
                className={styles.input}
                required
                disabled={loading}
            ...
            <>
              <div className={styles.formGroup}>
                ...
                <UnitMeasureAutocomplete
                  ...
                  onChange={(unitName) =>
                    handleInputChange("unidadMedida", unitName)
                  }
                  disabled={loading}
                  required
                />
              ...
              <div className={styles.formRow}>
                <div className={styles.formGroup}>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleNumberChange("stockMin", e.target.value)
                    }
                    min="0"
                ...
                <div className={styles.formGroup}>
                  <label className={styles.label}>Valor Unitario (COP)</label>
                  <div className={styles.currencyInput}>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleNumberChange("valorUnitario", e.target.value)
                      }
                      min="0"
                      step="0.01"
                      className={styles.input}
