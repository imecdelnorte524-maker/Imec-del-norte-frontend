...
export default function Roles() {
  const { roles, loading, error, deleteRole, createRole, updateRole } =
    useRoles();
  ...
  const [selectedRoleForModules, setSelectedRoleForModules] =
  ...
  // 🔥 CORREGIDO: Usar React Query en lugar de recargar página
  const handleModulesSaved = () => {
    // Refrescar los roles desde el servidor
